                    ...
                    <div class="owl-carousel brands-carousel-6">
                        ...
                        <div
                            ...
                            <a href="#">
                                ...
                                <img class="img-fluid light-theme-img" src="images/brand-6.png" alt="brand-logo">
                                @else
                                <img class="img-fluid light-theme-img" src="{{ asset($client->company_image) }}" alt="{{ $client->company_name}}">
                                @endif
                            </a>
