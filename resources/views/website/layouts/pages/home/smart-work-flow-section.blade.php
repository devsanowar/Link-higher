        ...
        <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  items-center">
            ...
            <div
                ...
                <div class="txt-block left-column wow fadeInRight">
                    ...
                    <!-- CONTENT BOX #2 -->
                    @foreach ($smarterWorkFlows as $key => $smarterWorkFlow)
                        <div
                            ...
                            <div
                                ...
                                {{ $smarterWorkFlow->title ?? '' }}</h5>
                                <p class="!leading-[1.6666] !mb-0">{!! $smarterWorkFlow->description ?? '' !!}
                                </p>
                            </div>
                        </div>
                    @endforeach
            ...
            <div
                ...
                <div class="img-block !text-center wow fadeInLeft ml-[30px] lg:max-xl:ml-[15px] md:max-lg:ml-[15px]">
                    @if (empty($smarterWorkFlowImage->image))
                        <img class="img-fluid max-w-none inline-block lg:max-xl:!max-w-[175%] md:max-lg:!max-w-[220%]"
                            src="images/tablet-01.png" alt="content-image">
                    @else
                        <img class="img-fluid max-w-none inline-block lg:max-xl:!max-w-[175%] md:max-lg:!max-w-[220%]"
                            src="{{ asset($smarterWorkFlowImage->image) }}" alt="content-image">
                    @endif
                </div>
            </div>
        </div>
