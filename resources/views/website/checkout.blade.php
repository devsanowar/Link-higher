            ...
            <div class="grid">
                <div class="ck-card">
                    <h2 class="custom-section-title"
                        style="margin-bottom: 10px; text-transform: uppercase; font-size: 24px;">Checkout</h2>
                    ...
                    <div class="checkout">
                        ...
                        <div>
                            ...
                            <form id="checkout-form" class="ck-card" action="{{ route('order.process') }}" method="POST"
                                novalidate>
                                @csrf
                                ...
                                <div>
                                    <div>
                                        ...
                                        <input id="fname" name="fname" class="ck-input" placeholder="John"
                                ...
                                <div class="row">
                                    <div>
                                        ...
                                        <input id="city" name="city" class="ck-input" placeholder="Enter City"
                                            value="{{ old('city') }}" required>
                                    </div>
                                    <div>
                                        <label for="zip">ZIP / Postal</label>
                                        <input id="zip" name="zip" class="ck-input" placeholder="1000"
                        ...
                        <aside class="ck-card summary">
                                ...
                                <div class="product">
                                    @if ($imagePath)
                                        ...
                                        <img src="{{ asset('storage/' . ltrim($imagePath, '/')) }}"
                                            alt="{{ $name }}" class="thumb">
                                    @else
                                        <img src="{{ asset('frontend/images/placeholder.png') }}" alt="placeholder"
                                            class="thumb">
                                    @endif
                            ...
                            <div>
                                <label><input type="radio" name="payment_method" value="cod" checked> Cash on Delivery
                                    (COD)</label><br>
                                <label><input type="radio" name="payment_method" value="paypal"> PayPal</label><br>
                                <label><input type="radio" name="payment_method" value="paddle"> Paddle</label>
                            </div>
                            ...
                            <div style="display:flex; gap:8px; margin-top:12px">
                                ...
                                <button form="checkout-form" class="ck-btn btn-primary checkout-button"
                                    style="flex:1; border:0; padding:12px 14px;">
                                    Checkout
                                </button>
                            </div>
                        </aside>
