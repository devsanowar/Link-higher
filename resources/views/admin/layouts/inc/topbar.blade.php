<nav class="navbar">
    <div class="col-12">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#" target="_blank">{{ $website_settings->website_title }}</a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            {{-- <li class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle xs-hide" data-toggle="dropdown" role="button"><i
                ...
                <ul class="dropdown-menu slideDown">
                    ...
                    <li class="body">
                        <ul class="menu list-unstyled">
                            ...
                            <li><a href="javascript:void(0);">
                                    <div class="icon-circle g-bg-cyan"> <i class="material-icons">delete_forever</i>
                                    </div>
                                    <div class="menu-info">
