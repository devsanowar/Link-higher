...
@section('title', 'Create Smart Solution Feature')
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea
                                                ...
                                                required
                                            >{{ old('feature_description') }}</textarea>
                                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary px-5 rounded-0" id="submitBtn">
                                        <span id="btnText">CREATE FEATURE</span>
...
<script>
    $(document).ready(function() {
        $("#AddFeatureForm").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('home.smart-solution-features.store') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        toastr.success(response.message || 'Feature created successfully.');
                    } else {
