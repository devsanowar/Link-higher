                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" step="0.01" id="price" name="price"
                                                ...
                                                placeholder="100.00" value="{{ old('price', $product->price) }}">
                                        </div>
                                        @error('price')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-7">
                                    <input type="number" id="ahrefs_dr" name="ahrefs_dr" class="form-control"
                                        placeholder="26" value="{{ old('ahrefs_dr', $product->ahrefs_dr) }}">
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-7">
                                    <input type="number" id="moz_da" name="moz_da" class="form-control"
                                        placeholder="25" value="{{ old('moz_da', $product->moz_da) }}">
                                </div>
                            </div>
                            ...
                            <div class="row clearfix mt-2">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-7">
                                    <input type="number" id="traffic" name="traffic" class="form-control"
                                        placeholder="8000" value="{{ old('traffic', $product->traffic) }}">
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-7">
                                    <input type="number" id="moz_pa" name="moz_pa" class="form-control"
                                        placeholder="25" value="{{ old('moz_da', $product->moz_pa) }}">
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="target_country" name="target_country"
                                                ...
                                                value="{{ old('target_country', $product->target_country) }}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div style="border: 1px solid #ccc">
                                            <textarea name="product_description" id="description" rows="4" class="form-control" style="padding: 5px 10px"
                                                placeholder="Write product description...">{!! old('description', $product->product_description ?? '') !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($product->image)
                                            <img id="previewImage" src="{{ asset($product->image) }}"
                                                alt="Preview Image" class="mt-2 border rounded" width="120">
                                        @else
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <select id="news" name="news" class="form-control show-tick">
                                            <option value="1"
                                                {{ old('news', $product->news ?? 1) == 1 ? 'selected' : '' }}>Yes</option>
                                            <option value="0"
                                                {{ old('news', $product->news ?? 1) == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
