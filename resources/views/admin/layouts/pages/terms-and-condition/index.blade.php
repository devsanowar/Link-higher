    ...
    <div class="row clearfix">
        <div class="col-lg-12 mt-4">
            <div class="card">
                ...
                <div class="body">
                    <form id="termsAndConditionUpdateForm" method="POST">
                        @csrf
                        @method('PUT')

                        <div class="form-group">
                            <label for="terms_and_conditions"><b>Page Content</b></label>
                            <textarea rows="5" id="terms_and_conditions" name="terms_and_conditions">{!! $termsAndCondition->terms_and_conditions ?? '' !!}</textarea>
                        </div>
...
<script>
    $(document).ready(function() {
        $("#termsAndConditionUpdateForm").submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('terms.and.conditions.update') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
